...
If `Current phase: done` and you still want to re-run a specific phase, edit `<VAULT>/setup-state.md` to set Current phase to the phase name (e.g., `step-7-web-shell`) before invoking this command.
